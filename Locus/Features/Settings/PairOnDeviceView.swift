...
struct PairOnDeviceView: View {
    ...
    private var header: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("LocationSim Personal advertises a pairable host. iOS connects from Developer Mode, then the app shows a 6-digit code for you to type.")
                .font(.subheadline)
    ...
    private var embeddedIntro: some View {
        VStack(alignment: .leading, spacing: 8) {
            Text("Follow these steps")
                .font(.headline)
            Text("Keep LocationSim Personal open. You’ll leave briefly for Settings, then come back with a code.")
                .font(.subheadline)
                .foregroundStyle(.secondary)
        }
    }
    ...
    private var steps: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            step(3, "Open Settings › Privacy & Security › Developer Mode › Pair with LocationSim Personal → Pair.")
            step(4, "Enter your unlock passcode first. On the next prompt, type the app’s 6-digit code.")
        }
        .padding(16)
    ...
    private var tipCard: some View {
        VStack(alignment: .leading, spacing: 6) {
            ...
            Text("Keep the app listening while you confirm in Developer Mode. Don’t force-quit. If the pairing option vanishes, stop/start pairing and reopen Developer Mode.")
                .font(.caption)
                .foregroundStyle(.secondary)
        }
        .padding(14)
        ...
        VStack(spacing: 14) {
            ...
            case .advertising:
                ...
                Text("Waiting for Settings…")
                    .font(.headline)
                Text("In Developer Mode tap Pair with LocationSim Personal → Pair.")
                    .font(.caption)
                    .foregroundStyle(.secondary)
    ...
    private var actions: some View {
        ...
        case .advertising, .deviceConnected, .awaitingPIN:
            Text({
                ...
                default: return "Waiting for iOS to connect… don’t force-quit LocationSim Personal."
                }
            }())
                .font(.caption)
                .foregroundStyle(.secondary)
